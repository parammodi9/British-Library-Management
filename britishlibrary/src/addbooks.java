...
public class addbooks extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      int book_id  ,edition;
      book_name=jTextField1.getText();
      book_id=Integer.parseInt(jTextField2.getText());
     author=jTextField3.getText();
      publisher=jTextField5.getText();
      edition=Integer.parseInt(jTextField4.getText());
      ...
      try
      {
          ...
          String q="insert into addbooks values('"+book_name+"','"+book_id+"','"+author+"','"+edition+"','"+publisher+"');";
